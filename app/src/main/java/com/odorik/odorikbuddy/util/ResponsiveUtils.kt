...
@Composable
fun getResponsiveChartHeight(): Dp {
    val configuration = LocalConfiguration.current
...
@Composable
fun getResponsiveBodyMediumSize() = getResponsiveBodyLargeSize() * 0.93f

@Composable
fun getResponsiveBodySmallSize() = getResponsiveBodyLargeSize() * 0.85f

@Composable
fun getResponsiveCaptionSize() = getResponsiveBodyLargeSize() * 0.80f